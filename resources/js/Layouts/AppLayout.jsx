...
import { PiHouse, PiLockKeyOpen, PiPlus, PiSidebar, PiSquare, PiSquaresFour, PiUser, PiX } from 'react-icons/pi';
                ...
                <li>
                  <ul role="list" className="-mx-2 space-y-2">
                    ...
                    <li>
                      <Link
                        href="#"
                        className="flex gap-x-3 rounded-md p-3 text-sm font-semibold leading-relaxed tracking-tighter text-foreground hover:bg-gray-100"
                      >
                        <PiHouse className="h-6 w-6 shrink-0 text-foreground" />
                        Dashboard
                      </Link>
